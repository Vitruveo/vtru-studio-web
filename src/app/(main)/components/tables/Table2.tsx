...
const rows = [
    {
        status: 'active',
        avatar: '/images/profile/profileDefault.png',
        name: 'Olivia Rhye',
        project: 'Xtreme admin',
        percent: 60,
        users: [{ img: '/images/profile/profileDefault.png' }, { img: '/images/profile/user-2.jpg' }],
    },
    {
        status: 'cancel',
        ...
        percent: 30,
        users: [
            { img: '/images/profile/profileDefault.png' },
