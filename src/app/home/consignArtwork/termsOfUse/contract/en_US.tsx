...
export default function Contract() {
    return (
        <>
            ...
            <p style={{ textAlign: 'justify' }}>
                For purposes of this Agreement, “user”, “you”, and “your” mean you as the user of the Service. If you
                use the Service on behalf of a company or other entity then “you” includes you and that entity, and you
                represent and warrant that (a) you are an authorized representative of the entity with the authority to
            ...
            <p style={{ textAlign: 'justify' }}>
                <strong>1.</strong> <strong>Definition User:</strong>
            </p>
            ...
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                1.2&nbsp; Users have the right to access and use the company's platform and services, subject to
                compliance with the terms and any applicable laws, regulations, or policies. Users are responsible for
                the accuracy, legality, and appropriateness of the content they upload, share, or otherwise make
                available on the company's platform. The company reserves the right to enforce the terms, suspend or
                terminate a User's access, or take appropriate action if a User is in violation of the terms or engages
            ...
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                ...
                infringement, or violates your publicity or other intellectual property rights, please submit your
                notice of infringement.
            </p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>7.2 Takedown Procedure:</p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                a. The Takedown Notice shall be submitted in writing and include the following:
            </p>
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                · &nbsp; Identification of the copyrighted work(s), trademark, publicity rights, or other intellectual
                property rights that are claimed to be infringed.
            </p>
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                · &nbsp; Identification of the allegedly infringing material, including specific location details (e.g.,
                URLs) on the Service where the material is found.
            </p>
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
            ...
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                &nbsp;&nbsp;&nbsp;i. A statement affirming your good faith belief that the use of the material is not
                authorized by the intellectual property rights owner, its agent, or the law.&nbsp;
            </p>
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                &nbsp;&nbsp;&nbsp;ii. An assertion of the accuracy of the information provided in the notice.
            </p>
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                &nbsp;&nbsp;iii. A statement, under penalty of perjury, confirming that you are authorized to act on
                behalf of the intellectual property owner.
            </p>
            ...
            <p style={{ marginLeft: 96, textAlign: 'justify' }}>
                a. Upon receipt of a valid Takedown Notice, the company will promptly investigate the claim and, if
                appropriate, take down or disable access to the allegedly infringing material.
            </p>
            <p style={{ marginLeft: 96, textAlign: 'justify' }}>
                b. Upon receiving your notice of intellectual property infringement, including your contact information,
                the company will forward this information to the concerned party responsible for the content's removal.
                This enables them to understand the reason for removal and allows them to contact you for dispute
                resolution.
            </p>
            <p style={{ marginLeft: 72, textAlign: 'justify' }}>
                7.5&nbsp; No Liability: The Company shall not be held liable for any damages resulting from its good
                faith actions taken in response to a Takedown Notice.The Company has the right to terminate a User's
                access to the Service if the User is found to be a repeat infringer.
            </p>
            <p style={{ textAlign: 'justify' }}>
                &nbsp;<span style={{ fontFamily: 'Arial,sans-serif' }}> </span>
            </p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                <strong>8.</strong> <strong>Use of Assets for Marketing Purposes:</strong>
            </p>
            ...
            <p style={{ marginLeft: 100, textAlign: 'justify' }}>
                This clause shall supplement and not override any other provisions outlined in this Agreement related to
                content usage, licensing, or intellectual property rights.
            </p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
            ...
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                ...
                under or in connection with this contract shall be in writing and shall be: delivered by hand, courier
                or email to the&nbsp; authorised address&nbsp; as follows:
            </p>
            <ul>
                <li style={{ listStyleType: 'disc' }}>
                    Address: 6th Floor, Waters Edge, &nbsp; Building 1, Wickham’s Cay 2, Road Town, Tortola, British
                    Virgin Islands&nbsp;
                </li>
            ...
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                <strong>12.</strong> <strong>Representations and Warranties:</strong> Both parties represent and warrant
                that they have the full power and authority to enter into this Agreement and perform their obligations
                herein.
            </p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                <strong>13.</strong>&nbsp; <strong>Governing Law:</strong> This Agreement shall be governed by and
                construed in accordance with the laws of British Virgin Islands, without regard to its conflict of law
                principles.
            </p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                <strong>14.</strong>&nbsp; <strong>Entire Agreement:</strong> This Agreement constitutes the entire
                understanding between the Parties concerning the subject matter hereof and supersedes all prior
                agreements, discussions, or understandings.
            </p>
            <p style={{ marginLeft: 48, textAlign: 'justify' }}>
                <strong>15.</strong>&nbsp; <strong>Amendments:</strong> Any amendments or modifications to this
