        ...
        <Box
          ...
          {isDragActive ? (
            ...
            <Typography align="center">
              Drag and drop files here or click to select files. Please note that only JPG, GIF, PNG, or MP4 file types
              are accepted.
            </Typography>
          )}
        </Box>
                      ...
                      return (
                        <Stack direction="column" alignItems="center" key={format.name}>
                          <Typography variant="h5">
                            {mediaDefinition.title} - {format.title} ({format.width}x{format.height})
                          </Typography>
                          <Crop
                            key={format.name}
