...
const language: Translation = {
    ...
    'studio.languages.englishUS': 'Inglés (US)',
    ...
    'studio.consignArtwork.assetMedia.dragAndDrop':
        'Arrastra y suelta un solo archivo de medios o haz clic para subir.',
    ...
    'studio.consignArtwork.assetMetadata.description': 'Completa todas las tareas y publica tu obra de arte',
    ...
    'studio.consignArtwork.licenses.description': 'Completa todas las tareas y publica tu obra de arte',
