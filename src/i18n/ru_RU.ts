...
const language: Translation = {
    ...
    'studio.consignArtwork.licenses.warning':
        'Произведения искусства Genesis гарантированно продаются по цене 150 долларов США за цифровые активы. Выберите лицензию NFT-ART-1, Single Edition и введите 150 долларов США. Вы также можете выбрать дополнительные лицензии.',
    ...
    'studio.consignArtwork.licenses.nft.description':
        'Эта лицензия делает произведение искусства доступным для продажи по одной из нескольких моделей ценообразования издания. При продаже Цифровой Актив произведения искусства чеканится и доставляется покупателю.',
