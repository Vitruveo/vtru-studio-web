...
const language: Translation = {
    ...
    'studio.consignArtwork.assetMetadata.field.profileUrl': 'Link do Perfil do Criador',
    'studio.consignArtwork.assetMetadata.field.profileUrl.description': 'Link do perfil do criador',
